    ...
    <div className="isolate bg-white p-5">
      <div className="flex items-center justify-between flex-wrap text-sm font-medium border-b-2 border-r-2 rounded-lg border-green-500">
        <p className=" py-12 text-center">
          ...
          important information on our website. If you still have questions or
          suggestions, we are happy to help. You can reach us via the contact
          form or using the following contact options
        </p>
      ...
      >
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-black px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
